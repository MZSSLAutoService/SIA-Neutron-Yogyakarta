                            ...
                            <div class="modal fade" id="modalAdd" tabindex="-1" role="dialog">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ url('tugasPost') }}" enctype="multipart/form-data" method="post">
                                        {{ csrf_field() }}
                                            <div class="form-group form-float form-group-lg">
                                                <div class="form-line">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-line">
                                                            <select name="siswa" class="form-control show-tick" data-live-search="true">
                                                                <option value="">-- Please select SISWA --</option>
                                                                @foreach($yi as $sia_siswa)
                                                                    <option value="{{$sia_siswa->id}}">{{$sia_siswa->name}}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                                    </div>
                            ...
                            <div class="modal fade" id="modalImport" tabindex="-1" role="dialog">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                            <h4 class="modal-title" id="myModalLabel">Import Tugas(BELUM)</h4>
                                        </div>
                                        <div class="modal-body">
                                        <form action="{{ url('tugasImport') }}" method="post" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                            <div class="form-group form-float form-group-lg">
                                                <div class="form-line">
                                                ...
                                                <div class="modal fade" id="modalEdit{{$abs->id}}" tabindex="-1" role="dialog">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="{{ route('tugas.update', $abs->id) }}" enctype="multipart/form-data" method="post">
                                                                {{ csrf_field() }}
                                                                @method('PUT')
                                                                    <div class="form-group form-float form-group-lg">
                                                                        <div class="form-line">
                                                ...
                                                <div class="modal fade" id="modalHapus{{$abs->id}}" tabindex="-1" role="dialog">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                            <form action="{{ route('tugas.destroy', $abs->id) }}" method="POST">
                                                            {{ csrf_field() }}
                                                            @method('DELETE')
